...
[![CI Build](https://github.com/ivan44112/gh-demo-lib/actions/workflows/ci.yml/badge.svg)](https://github.com/ag04/gh-demo-lib/actions/workflows/ci.yml)
...
repositories {
    ...
    maven {
        name = "GitHubPackages"
        url = uri("https://maven.pkg.github.com/ivan44112/gh-demo-lib")
        credentials {
